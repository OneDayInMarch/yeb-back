...
public class EmployeeController {
    ...
    public RespPageBean getEmployee(@RequestParam(defaultValue = "1") Integer currentPage,
                                    ...
                                    Employee employee,
                                    @RequestParam(required = false)LocalDate[] beginDateScope) {
    ...
    public RespBean importEmployee(MultipartFile file) {
        ...
        try {
            ...
            list.forEach(employee -> {
                ...
                //政治面貌id
                employee.setPoliticId(politicsStatusesList.get(politicsStatusesList.indexOf(
                        new PoliticsStatus(employee.getPoliticsStatus().getName()))).getId());
                //部门id
                employee.setDepartmentId(departmentsList.get(departmentsList.indexOf(new
                        Department(employee.getDepartment().getName()))).getId());
                //职称id
                employee.setJobLevelId(joblevelsList.get(joblevelsList.indexOf(new
                        Joblevel(employee.getJoblevel().getName()))).getId());
                //职位id
                employee.setPosId(positionsList.get(positionsList.indexOf(new
